...
public class BeanDefinitionParserDelegate {
	...
	public AbstractBeanDefinition parseBeanDefinitionAttributes(Element ele, String beanName,
		...
		// scope和singleton两个属性只能出现其一，否则会报出异常
	...
	public void parseConstructorArgElement(Element ele, BeanDefinition bd) {
		...
		/*
		   如果配置中指定可index属性：
		      ...
		      3.将type、name、index属性一并封装在ConstructorArgumentValues.ValueHolder，并添加至当前BeanDefinition的
		      constructorArgumentValues的indexedArgumentValue属性中;
		   如果没有指定index属性：
		      1.解析constructor-arg子元素；
		      2.使用ConstructorArgumentValues.ValueHolder封装解析出来的元素;
		      3.将type、name、index属性一并封装在ConstructorArgumentValues.ValueHolder，并添加至当前BeanDefinition的
		      constructorArgumentValues的genericArgumentValue属性中;
		 */
